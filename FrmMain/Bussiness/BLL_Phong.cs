...
namespace FrmMain.Bussiness
{
    class BLL_Phong
    {
       ...
       public DataTable GetDanhSachPhong(ref string err)
       {
           return data.GetDataTable(ref err, "PSP_Phong_Select", CommandType.StoredProcedure, null);
       }
       public bool InsertUpdatePhong(ref string err, DTO.DTO_Phong _phong)
       {
       ...
       public bool DeletePhong(ref string err, string maphong, ref int sodong)
       {
